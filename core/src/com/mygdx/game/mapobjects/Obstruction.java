...
public interface Obstruction{
    ...
    default List<Vector2> getBypass(Vector2 location, Vector2 target){
        ...
        try{ //used to predict stupid bugs
            ...
            //index of closest corner-point for secondIntersection-point
            ...
            //predict stupid bugs if something went wrong
            //set current location as target point to predict zombie moving
            target.set(location);
